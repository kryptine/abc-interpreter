...
opt_abc_new2 [Iupdate_a 0 d0,Ipop_a 1:is] = case is of
	[a=:(Annotation _),Ijmp l:is] -> [a,Iput_a_jmp d0 l:opt_abc_new2 is]
	_                             -> [  Iput_a     d0  :opt_abc_new2 is]
opt_abc_new2 [Iupdate_b 0 d0,Ipop_b 1:is] = case is of
	[a=:(Annotation _),Ijmp l:is] -> [a,Iput_b_jmp d0 l:opt_abc_new2 is]
