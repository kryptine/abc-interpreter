...
char *instruction_type (BC_WORD i) {
	switch (i){
		...
		case Cbuildh0:               return "l"; break;
		case Cbuildh1:               return "l"; break;
		case Cbuildh2:               return "l"; break;
		...
		case Cbuildh0_dup_a:         return "ln"; break;
		case Cbuildh0_dup2_a:        return "ln"; break;
		case Cbuildh0_dup3_a:        return "ln"; break;
		...
		case Cjmp_ne_desc:           return "nll"; break;
		...
		case Cpop_ab_rtn:            return "nn"; break;
		case Cpop_a_jmp:             return "nl"; break;
		case Cpop_a_jsr:             return "nl"; break;
		case Cpop_b_jmp:             return "nl"; break;
		case Cpop_b_jsr:             return "nl"; break;
		case Cpop_b_pushBFALSE:      return "n"; break;
		case Cpop_b_pushBTRUE:       return "n"; break;
		...
		case Cupdates2_a:            return "nnn"; break;
