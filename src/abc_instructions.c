...
char *instruction_type (BC_WORD i) {
	switch (i){
		...
		case Cpush_a2:               return "?";
		case Cpush_ab:               return "nn";
		case Cpush_b2:               return "nn";
		case Cpush2_a:               return "?";
		case Cpush2_b:               return "?";
		case Cpush3_a:               return "?";
		case Cpush3_b:               return "?";
