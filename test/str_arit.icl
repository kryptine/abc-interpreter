...
/*
String Arithmetic.
This program demonstrates string arithmetic by mergesorting the characters of a
large string.
It is slightly adapted from the version found in Clean's small examples, to
return a list of characters rather than a String. This is because currently the
interpreter cannot print Strings.
*/
...
// mul_S is needed to create the large string.
